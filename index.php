		...
		<div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <div class="page-title">
                    <h3 style='position:relative; left:20px'>Home</h3>
                </div>
                <div class="col-md-12">
					<div class="card ">
						<div class="card-header" style="background-color: #3acf61">
							<h4 style="color: white"><strong><center>Login Successfully</center></strong></h4>
						 </div>
						<div class="card-body">
							<br>
							<div class="row">
							...
							<p class="col-md-12 col-12"><b>Username: </b><u><?php echo $_SESSION['username']; ?></u></p>
